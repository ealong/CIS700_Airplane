...
public abstract class Player {
	 ...
	 * It returns the number of rounds (including the argument value)
	 * that it takes to complete the simulation. It returns -1 times that
	 * number if an error occurs during the simulation.
     */
    protected int startSimulation(ArrayList<Plane> planes, int round) {
